...
for i  = 1 : rule
    for j = 1 : rule
EV0_mu1{i}{j}  = LMIfunc(A{i},Ad{i},B{i},0,   mu1,h,mu1,mu2,P0,P1,Q1,Q2,R11,R12,R21,R22,R31,R32,L{i},Y1til,Y2til,M1til,M2til,Sigma,X,J{j},n);
EVh2_mu1{i}{j} = LMIfunc(A{i},Ad{i},B{i},h/2, mu1,h,mu1,mu2,P0,P1,Q1,Q2,R11,R12,R21,R22,R31,R32,L{i},Y1til,Y2til,M1til,M2til,Sigma,X,J{j},n);
EVh_mu1{i}{j}  = LMIfunc(A{i},Ad{i},B{i},h,   mu1,h,mu1,mu2,P0,P1,Q1,Q2,R11,R12,R21,R22,R31,R32,L{i},Y1til,Y2til,M1til,M2til,Sigma,X,J{j},n);

EV0_mu2{i}{j}  = LMIfunc(A{i},Ad{i},B{i},0,   mu2,h,mu1,mu2,P0,P1,Q1,Q2,R11,R12,R21,R22,R31,R32,L{i},Y1til,Y2til,M1til,M2til,Sigma,X,J{j},n);
EVh2_mu2{i}{j} = LMIfunc(A{i},Ad{i},B{i},h/2, mu2,h,mu1,mu2,P0,P1,Q1,Q2,R11,R12,R21,R22,R31,R32,L{i},Y1til,Y2til,M1til,M2til,Sigma,X,J{j},n);
EVh_mu2{i}{j}  = LMIfunc(A{i},Ad{i},B{i},h,   mu2,h,mu1,mu2,P0,P1,Q1,Q2,R11,R12,R21,R22,R31,R32,L{i},Y1til,Y2til,M1til,M2til,Sigma,X,J{j},n);
